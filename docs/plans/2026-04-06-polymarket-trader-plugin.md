...
All paths relative to `D:/work/polymarket-trader/` (the RivonClaw repo).

### Plugin (TypeScript)

```
polymarket-trader/
├── package.json                          # pnpm package, no deps on RivonClaw/OpenClaw packages
...
├── src/
│   ├── index.ts                          # definePlugin() entry — wires everything
│   ├── plugin-sdk.ts                     # inlined OpenClaw plugin types + definePlugin() helper
│   ├── config/
...
~/.openclaw/openclaw.json (modified by user before M2)
  plugins.entries += "polymarket-trader"
...
Run: `find D:/work/polymarket-trader/vendor/openclaw/docs -type f -name "*.md" | xargs grep -l -i "agent.run\|invoke.*agent\|runAgent"`
...
Read: `D:/work/polymarket-trader/packages/gateway/src/rpc-client.ts`
...
Run: `find D:/work/polymarket-trader/vendor/openclaw -type f \( -name "*.md" -o -name "*.ts" \) | xargs grep -l -i "cron\|schedule" 2>/dev/null | head -20`
...
**Files:**
- Create: `polymarket-trader/package.json`
- Create: `polymarket-trader/tsconfig.json`
- Create: `polymarket-trader/tsdown.config.ts`
- Create: `polymarket-trader/vitest.config.ts`
- Create: `polymarket-trader/openclaw.plugin.json`
- Create: `polymarket-trader/README.md`
- Create: `polymarket-trader/src/index.ts`
...
```json
{
  ...
  "version": "0.1.0",
  "description": "Standalone Polymarket event-driven trading plugin (loadable into any OpenClaw-compatible runtime, including RivonClaw)",
  "type": "module",
  "main": "./dist/polymarket-trader.mjs",
  "types": "./dist/polymarket-trader.d.ts",
  "exports": {
    ".": {
      "types": "./dist/polymarket-trader.d.ts",
      "import": "./dist/polymarket-trader.mjs"
    }
  },
  "openclaw": {
    "extensions": ["./dist/polymarket-trader.mjs"]
  },
...
- No `@rivonclaw/*` dependencies — the plugin SDK helper is inlined as `src/plugin-sdk.ts` (Task 1.5)
- No `@mariozechner/openclaw` dependency — the OpenClaw plugin API types are inlined in the same file
- No monorepo workspace references
- `pnpm install` from a fresh clone works without any external linkage
...
```bash
cd D:/work/polymarket-trader
pnpm install --filter polymarket-trader
pnpm build
```
Expected: build succeeds, `polymarket-trader/dist/polymarket-trader.mjs` exists.

- [ ] **Step 9: Add a trivial passing test to verify vitest wiring**

Create `polymarket-trader/tests/smoke.test.ts`:
```typescript
...
```bash
cd D:/work/polymarket-trader
git add package.json tsconfig.json tsdown.config.ts vitest.config.ts openclaw.plugin.json README.md src/ tests/
git commit -m "feat: bootstrap empty plugin with build and smoke test"
```

### Task 1.5: Inline plugin SDK helper (zero external dependencies)

Because this is a standalone project with no `@rivonclaw/plugin-sdk` or `@mariozechner/openclaw` deps, we inline the minimal types and helper function needed to define an OpenClaw plugin.

**Files:**
- Create: `polymarket-trader/src/plugin-sdk.ts`
- Test: `polymarket-trader/tests/plugin-sdk.test.ts`
...
- [ ] **Step 3: Implement `src/plugin-sdk.ts`**
...
**Files:**
- Create: `polymarket-trader/src/db/schema.sql`
- Create: `polymarket-trader/src/db/migrations.ts`
- Create: `polymarket-trader/src/db/connection.ts`
- Test: `polymarket-trader/tests/db/migrations.test.ts`
...
Run: `pnpm test:run tests/db/migrations.test.ts`
...
```bash
git add -f polymarket-trader/src/db/ polymarket-trader/tests/db/ polymarket-trader/tsdown.config.ts
...
**Files:**
- Create: `polymarket-trader/src/db/signal-log-repo.ts`
- Create: `polymarket-trader/src/db/types.ts`
- Test: `polymarket-trader/tests/db/signal-log-repo.test.ts`
...
Run: `pnpm test:run tests/db/signal-log-repo.test.ts`
...
```bash
git add -f polymarket-trader/src/db/signal-log-repo.ts polymarket-trader/src/db/types.ts polymarket-trader/tests/db/signal-log-repo.test.ts
...
**Files:**
- Create: `polymarket-trader/src/db/portfolio-state-repo.ts`
- Create: `polymarket-trader/src/db/filter-config-repo.ts`
- Create: `polymarket-trader/src/db/filter-proposals-repo.ts`
- Create: `polymarket-trader/src/db/kill-switch-repo.ts`
- Create: `polymarket-trader/src/db/strategy-performance-repo.ts`
- Test: `polymarket-trader/tests/db/portfolio-state-repo.test.ts`
...
Run: `pnpm test:run tests/db/portfolio-state-repo.test.ts`
Expected: FAIL — module not found.
...
Run: `pnpm test:run tests/db/`
Expected: all tests pass.

- [ ] **Step 7: Commit**

```bash
git add -f polymarket-trader/src/db/ polymarket-trader/tests/db/
...
**Files:**
- Create: `polymarket-trader/src/config/schema.ts`
- Create: `polymarket-trader/src/config/defaults.ts`
- Create: `polymarket-trader/src/config/loader.ts`
- Test: `polymarket-trader/tests/config/loader.test.ts`
...
```bash
git add -f polymarket-trader/src/config/ polymarket-trader/tests/config/
...
**Files:**
- Create: `polymarket-trader/src/executor/price-bucket.ts`
- Test: `polymarket-trader/tests/executor/price-bucket.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/price-bucket.ts polymarket-trader/tests/executor/price-bucket.test.ts
...
**Files:**
- Create: `polymarket-trader/src/util/time.ts`
- Create: `polymarket-trader/src/util/errors.ts`
...
```bash
git add -f polymarket-trader/src/util/
...
**Files:**
- Create: `polymarket-trader/src/bus/types.ts`
- Create: `polymarket-trader/src/bus/events.ts`
- Test: `polymarket-trader/tests/bus/events.test.ts`
...
```bash
git add -f polymarket-trader/src/bus/ polymarket-trader/tests/bus/
...
**Files:**
- Create: `polymarket-trader/src/collector/bot-filter.ts`
- Test: `polymarket-trader/tests/collector/bot-filter.test.ts`
...
```bash
git add -f polymarket-trader/src/collector/bot-filter.ts polymarket-trader/tests/collector/bot-filter.test.ts
...
**Files:**
- Create: `polymarket-trader/src/collector/rolling-window.ts`
- Test: `polymarket-trader/tests/collector/rolling-window.test.ts`
...
```bash
git add -f polymarket-trader/src/collector/rolling-window.ts polymarket-trader/tests/collector/rolling-window.test.ts
...
**Files:**
- Create: `polymarket-trader/src/collector/trigger-evaluator.ts`
- Test: `polymarket-trader/tests/collector/trigger-evaluator.test.ts`
...
```bash
git add -f polymarket-trader/src/collector/trigger-evaluator.ts polymarket-trader/tests/collector/trigger-evaluator.test.ts
...
**Files:**
- Create: `polymarket-trader/src/collector/market-state.ts`
- Test: `polymarket-trader/tests/collector/market-state.test.ts`
...
```bash
git add -f polymarket-trader/src/collector/market-state.ts polymarket-trader/tests/collector/market-state.test.ts
...
**Files:**
- Create: `polymarket-trader/src/collector/ws-client.ts`
- Test: `polymarket-trader/tests/collector/ws-client.test.ts`

- [ ] **Step 1: Investigate the actual Polymarket WS protocol**

Run: `find D:/work/polymarket-trader -name "*.ts" -path "*node_modules*polymarket*" 2>/dev/null | head -5`
...
```bash
git add -f polymarket-trader/src/collector/ws-client.ts polymarket-trader/tests/collector/ws-client.test.ts
...
**Files:**
- Create: `polymarket-trader/src/collector/collector.ts`
- Test: `polymarket-trader/tests/collector/collector.test.ts`
...
```bash
git add -f polymarket-trader/src/collector/collector.ts polymarket-trader/tests/collector/collector.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/kelly.ts`
- Test: `polymarket-trader/tests/executor/kelly.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/kelly.ts polymarket-trader/tests/executor/kelly.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/pnl.ts`
- Test: `polymarket-trader/tests/executor/pnl.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/pnl.ts polymarket-trader/tests/executor/pnl.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/circuit-breaker.ts`
- Test: `polymarket-trader/tests/executor/circuit-breaker.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/circuit-breaker.ts polymarket-trader/tests/executor/circuit-breaker.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/position-tracker.ts`
- Test: `polymarket-trader/tests/executor/position-tracker.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/position-tracker.ts polymarket-trader/tests/executor/position-tracker.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/paper-fill.ts`
- Test: `polymarket-trader/tests/executor/paper-fill.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/paper-fill.ts polymarket-trader/tests/executor/paper-fill.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/exit-monitor.ts`
- Test: `polymarket-trader/tests/executor/exit-monitor.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/exit-monitor.ts polymarket-trader/tests/executor/exit-monitor.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/conflict-lock.ts`
- Test: `polymarket-trader/tests/executor/conflict-lock.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/conflict-lock.ts polymarket-trader/tests/executor/conflict-lock.test.ts
...
**Files:**
- Create: `polymarket-trader/src/executor/executor.ts`
- Test: `polymarket-trader/tests/executor/executor.test.ts`
...
```bash
git add -f polymarket-trader/src/executor/executor.ts polymarket-trader/tests/executor/executor.test.ts
...
**Files:**
- Create: `polymarket-trader/src/analyzer/verdict-parser.ts`
- Test: `polymarket-trader/tests/analyzer/verdict-parser.test.ts`
...
```bash
git add -f polymarket-trader/src/analyzer/verdict-parser.ts polymarket-trader/tests/analyzer/verdict-parser.test.ts
...
**Files:**
- Create: `polymarket-trader/src/analyzer/context-packer.ts`
- Test: `polymarket-trader/tests/analyzer/context-packer.test.ts`
...
```bash
git add -f polymarket-trader/src/analyzer/context-packer.ts polymarket-trader/tests/analyzer/context-packer.test.ts
...
**Files:**
- Create: `polymarket-trader/src/analyzer/analyzer-client.ts`
- Test: `polymarket-trader/tests/analyzer/analyzer-client.test.ts`
...
```bash
git add -f polymarket-trader/src/analyzer/analyzer-client.ts polymarket-trader/tests/analyzer/analyzer-client.test.ts
...
- Create: `polymarket-trader/docs/AGENTS-analyzer.md` (template committed to repo)
...
Append to `polymarket-trader/README.md`:
...
cp polymarket-trader/docs/AGENTS-analyzer.md ~/.openclaw/agents/polymarket-analyzer/agent/AGENTS.md
```
...
```bash
git add -f polymarket-trader/docs/ polymarket-trader/README.md
...
**Files:**
- Create: `polymarket-trader/src/recovery/startup-recovery.ts`
- Test: `polymarket-trader/tests/recovery/startup-recovery.test.ts`
...
```bash
git add -f polymarket-trader/src/recovery/ polymarket-trader/tests/recovery/
...
**Files:**
- Modify: `polymarket-trader/src/index.ts`
...
```bash
git add -f polymarket-trader/src/index.ts
...
**Files:**
- Create: `polymarket-trader/src/reviewer/statistics.ts`
- Test: `polymarket-trader/tests/reviewer/statistics.test.ts`
...
```bash
git add -f polymarket-trader/src/reviewer/statistics.ts polymarket-trader/tests/reviewer/statistics.test.ts
...
**Files:**
- Create: `polymarket-trader/src/reviewer/kill-switch-decider.ts`
- Test: `polymarket-trader/tests/reviewer/kill-switch-decider.test.ts`
...
```bash
git add -f polymarket-trader/src/reviewer/kill-switch-decider.ts polymarket-trader/tests/reviewer/kill-switch-decider.test.ts
...
**Files:**
- Create: `polymarket-trader/src/reviewer/report-generator.ts`
- Test: `polymarket-trader/tests/reviewer/report-generator.test.ts`
...
```bash
git add -f polymarket-trader/src/reviewer/report-generator.ts polymarket-trader/tests/reviewer/report-generator.test.ts
...
**Files:**
- Create: `polymarket-trader/src/reviewer/reviewer.ts`
- Modify: `polymarket-trader/src/index.ts` (register gateway method)
...
```bash
git add -f polymarket-trader/src/reviewer/reviewer.ts polymarket-trader/src/index.ts
...
**Files:**
- Create: `polymarket-trader/docs/AGENTS-reviewer.md`
- Modify: `polymarket-trader/README.md`
...
cp polymarket-trader/docs/AGENTS-reviewer.md ~/.openclaw/agents/polymarket-reviewer/agent/AGENTS.md
```
...
```bash
git add -f polymarket-trader/docs/AGENTS-reviewer.md polymarket-trader/README.md
...
**Files:**
- Create: `polymarket-trader/tests/fixtures/polymarket-ws-sample.json`
- Create: `polymarket-trader/scripts/record-ws.mjs`
...
```bash
git add -f polymarket-trader/scripts/record-ws.mjs polymarket-trader/tests/fixtures/polymarket-ws-sample.json
...
**Files:**
- Create: `polymarket-trader/tests/e2e/paper-trading.test.ts`
...
Run: `pnpm test:run tests/e2e/paper-trading.test.ts`
Fix any integration mismatches.

- [ ] **Step 3: Commit**

```bash
git add -f polymarket-trader/tests/e2e/paper-trading.test.ts
...
```bash
git add -f polymarket-trader/tests/
...
**Files:**
- Create: `polymarket-trader/docs/m4-runbook.md`
...
```bash
git add -f polymarket-trader/docs/m4-runbook.md
...
**Files:**
- Create: `polymarket-trader/src/reviewer/alert-dispatcher.ts`
- Test: `polymarket-trader/tests/reviewer/alert-dispatcher.test.ts`
...
```bash
git add -f polymarket-trader/src/reviewer/alert-dispatcher.ts polymarket-trader/tests/reviewer/alert-dispatcher.test.ts polymarket-trader/src/reviewer/reviewer.ts polymarket-trader/src/index.ts
